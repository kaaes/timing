...
(function(){
	if(!window.__profiler__ || window.__profiler__.scriptLoaded !== true) {
		...
		l.style.cssText='z-index:999;position:fixed;top:10px;left:10px;display:inline;font-size:14px;line-height:1.5em;font-family:Helvetica,Calibri,Arial,sans-serif;text-shadow:none;padding:3px 10px 0;background:#FFFDF2;box-shadow:0 0 3px 10px rgba(0,0,0,.5),0 0 0 5px rgba(0,0,0,.5); border-radius:1px';
